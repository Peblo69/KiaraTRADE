...
import { 
  ...
  BarChart2, ArrowUp, ArrowDown, Target, Info
} from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-gray-900/50">
              <div className="flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="w-[200px] text-sm">Price level where selling pressure is expected to be strong, potentially preventing further upward movement.</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-gray-900/50">
              <div className="flex items-center gap-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="w-[200px] text-sm">Price level where buying interest is expected to be strong enough to prevent the price from falling further.</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div className="p-3 rounded-lg bg-gray-900/50">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="w-[200px] text-sm">Relative Strength Index (RSI) measures the speed and magnitude of recent price changes to evaluate overbought or oversold conditions. Values above 70 indicate overbought, below 30 indicate oversold.</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div className="p-3 rounded-lg bg-gray-900/50">
              <div className="flex items-center gap-2 mb-2">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p className="w-[200px] text-sm">Moving Average Convergence Divergence (MACD) shows the relationship between two moving averages of an asset's price. Positive values suggest bullish momentum, negative values suggest bearish momentum.</p>
                  </TooltipContent>
                </Tooltip>
              </div>
              <div className="flex items-center justify-between">
